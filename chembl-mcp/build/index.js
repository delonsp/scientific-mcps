...
class ChEMBLServer {
    ...
    async handleGetTargetCompounds(args) {
        ...
        try {
            ...
            const compoundIds = [...new Set(activities.map((a) => a.molecule_chembl_id))];
            return {
                content: [
                    {
                        type: 'text',
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get target compounds: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchByUniprot(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search by UniProt: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetTargetPathways(args) {
        ...
        try {
            ...
            const pathways = {
                ...
                pathways: (target.cross_references || []).filter((ref) => ref.xref_src === 'Reactome' || ref.xref_src === 'KEGG' || ref.xref_src === 'WikiPathways'),
            };
            return {
                content: [
                    {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get target pathways: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    ...
    async handleSearchByActivityType(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search by activity type: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetDoseResponse(args) {
        ...
        try {
            ...
            const doseResponseData = activities
                .filter((a) => a.standard_value !== null && a.standard_type)
                .map((a) => ({
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get dose response: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleCompareActivities(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to compare activities: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchDrugs(args) {
        ...
        try {
            ...
            const drugs = molecules.filter((m) => m.max_phase && m.max_phase >= 1);
            return {
                content: [
                    {
                        type: 'text',
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search drugs: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetDrugInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get drug info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchDrugIndications(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search drug indications: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetMechanismOfAction(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get mechanism of action: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleAnalyzeAdmetProperties(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to analyze ADMET properties: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    assessAbsorption(props) {
    ...
    async handleCalculateDescriptors(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to calculate descriptors: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handlePredictSolubility(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to predict solubility: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    assessPermeability(props) {
        const psa = props.psa || 0;
        const logp = props.alogp || 0;
    ...
    async handleAssessDrugLikeness(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to assess drug-likeness: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    getDrugLikenessRecommendation(violations, veberPass) {
    ...
    async handleSubstructureSearch(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to perform substructure search: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    ...
    async handleGetExternalReferences(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get external references: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    getExternalUrl(source, id) {
        const urlMap = {
    ...
    async handleAdvancedSearch(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to perform advanced search: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async run() {
